...
/** CUP v0.11b beta 20140220 generated parser.
  * @version Mon Jun 23 13:12:13 CEST 2014
  */
public class SyntacticAnalyzer extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\025\005\000\002\027\004\000\002\045\005\000\002\045" +
    "\004\000\002\046\005\000\002\046\003\000\002\030\004" +
    "\000\002\031\004\000\002\032\004\000\002\033\004\000" +
  ...
  protected static final short[][] _action_table = 
    ...
    "\002\000\014\040\uffc5\045\uffc5\052\124\054\123\055\122" +
    ...
    "\000\006\040\uffd4\045\uffd4\001\002\000\014\040\uffc6\045" +
    "\uffc6\052\124\054\123\055\122\001\002\000\010\014\uffd0" +
    ...
    "\002\000\006\040\uffcb\045\uffcb\001\002\000\006\041\217" +
    "\043\220\001\002\000\006\041\uffc9\043\uffc9\001\002\000" +
    "\026\020\130\026\140\027\126\030\133\042\131\057\132" +
    "\060\135\066\134\067\136\070\120\001\002\000\006\040" +
    "\uffcc\045\uffcc\001\002\000\006\041\uffca\043\uffca\001\002" +
    "\000\006\040\uffc7\045\uffc7\001\002\000\006\014\224\052" +
    "\206\001\002\000\006\040\uffd2\045\uffd2\001\002\000\026" +
    "\020\130\026\140\027\126\030\133\042\131\057\132\060" +
    "\135\066\134\067\136\070\120\001\002\000\006\040\uffd7" +
    "\045\uffd7\001\002\000\014\040\uffc8\045\uffc8\052\124\054" +
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\026\244\001\001\000\006\011\060\016\056\001\001\000" +
    ...
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "\000\004\015\241\001\001\000\002\001\001\000\004\015" +
  ...
  public final java_cup.runtime.Symbol CUP$SyntacticAnalyzer$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$SyntacticAnalyzer$act_num)
		...
		Instruccion aDeIB = (Instruccion)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		...
		List<DecTipos> aDeDT = (List<DecTipos>)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		...
		List<DecTipos> aDeDV = (List<DecTipos>)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		...
		List<DecSubprograma> aDeDSP = (List<DecSubprograma>)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 ...
		 RESULT = ops.decsecsubprogramasvacia(); 
          ...
          case 8: // DecTipos ::= DecTipos PYCOMA DecTipo 
            {
              List<DecTipos> RESULT =null;
		List<DecTipos> aDeDTS1 = (List<DecTipos>)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.elementAt(CUP$SyntacticAnalyzer$top-2)).value;
		...
		String lexDeNN = (String)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.elementAt(CUP$SyntacticAnalyzer$top-1)).value;
		 RESULT = ops.tipoint(aDeTipo, lexDeNN); 
          ...
          case 16: // Tipo ::= STRUCT LLAVEAP Campos LLAVECIERRE 
            {
              Tipo RESULT =null;
		List<DecTipos> aDeCampos = (List<DecTipos>)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.elementAt(CUP$SyntacticAnalyzer$top-1)).value;
		...
		Tipo aDeTipo = (Tipo)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.tipopointer(aDeTipo); 
          ...
          case 18: // Campos ::= Campos PYCOMA Campo 
            {
              List<DecTipos> RESULT =null;
		List<DecTipos> aDeCampos1 = (List<DecTipos>)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.elementAt(CUP$SyntacticAnalyzer$top-2)).value;
		...
		Tipo aDeTipo = (Tipo)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.dectipostring(lexDeID, aDeTipo); 
          ...
          case 21: // DecVariables ::= DecVariables PYCOMA DecVariable 
            {
              List<DecTipos> RESULT =null;
		List<DecTipos> aDeDVS1 = (List<DecTipos>)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.elementAt(CUP$SyntacticAnalyzer$top-2)).value;
		...
		List<Instruccion> aDeIS = (List<Instruccion>)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.elementAt(CUP$SyntacticAnalyzer$top-1)).value;
		 RESULT = aDeIS; 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("IBloque",20, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
		...
		Instruccion aDeI = (Instruccion)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.decinstcomp(aDeIS, aDeI); 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("Instrucciones",32, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
		...
		List<Exp> aDeArgs = (List<Exp>)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.instllamada(lexDeID, aDeArgs); 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("ILlamada",21, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
		...
		Designador aDeDesig = (Designador)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.instread(aDeDesig); 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("IRead",22, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
		...
		Exp aDeExp0 = (Exp)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.instwrite(aDeExp0); 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("IWrite",23, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
		...
		Designador aDeDesig = (Designador)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.instnew(aDeDesig); 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("INew",24, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
		...
		Designador aDeDesig = (Designador)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.instdelete(aDeDesig); 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("IDelete",25, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
		...
		String lexDeID = (String)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.designaid(lexDeID); 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("Designador",26, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
		...
		Exp aDeExp11 = (Exp)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.mkexp(opDeOpComp, aDeExp10, aDeExp11); 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("Exp0",27, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
		...
		Exp aDeExp2 = (Exp)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.mkexp(opDeOpAditivo, aDeExp11, aDeExp2); 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("Exp1",28, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
		...
		Exp aDeExp3 = (Exp)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.mkexp(opDeOpMultiplicativo, aDeExp21, aDeExp3); 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("Exp2",29, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
		...
		Exp aDeExp31 = (Exp)((java_cup.runtime.Symbol) CUP$SyntacticAnalyzer$stack.peek()).value;
		 RESULT = ops.mkexp(opDeOpUnario, aDeExp31); 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("Exp3",30, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
          ...
          case 73: // Exp4 ::= TRUE 
            {
              Exp RESULT =null;
		 RESULT = ops.exptrue(); 
              CUP$SyntacticAnalyzer$result = parser.getSymbolFactory().newSymbol("Exp4",31, RESULT);
            }
          return CUP$SyntacticAnalyzer$result;
